...
//调用公共头部
function insert_get_header()
{
    $GLOBALS['smarty']->assign('nav_cat', get_nav_category());
    return $GLOBALS['smarty']->fetch('library/page_header.dwt');
}

//调用公共底部
function insert_get_footer()
{
    $GLOBALS['smarty']->assign('nav_cat', get_nav_category());
    return $GLOBALS['smarty']->fetch('library/page_footer.dwt');
}
